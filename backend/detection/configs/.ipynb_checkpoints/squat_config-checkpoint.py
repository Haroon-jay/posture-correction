...
def on_side_view(coords, angles, COLORS, frame, linetype, font):
    shldr_coord = coords["shldr_coord"]
    elbow_coord = coords["elbow_coord"]
    wrist_coord = coords["wrist_coord"]
    hip_coord = coords["hip_coord"]
    knee_coord = coords["knee_coord"]
    ankle_coord = coords["ankle_coord"]
    foot_coord = coords["foot_coord"]
    ...
    cv2.circle(frame, shldr_coord[:2], 7, COLORS["yellow"], -1, lineType=linetype)
    cv2.circle(frame, elbow_coord[:2], 7, COLORS["yellow"], -1, lineType=linetype)
    cv2.circle(frame, wrist_coord[:2], 7, COLORS["yellow"], -1, lineType=linetype)
    cv2.circle(frame, hip_coord[:2], 7, COLORS["yellow"], -1, lineType=linetype)
    cv2.circle(frame, knee_coord[:2], 7, COLORS["yellow"], -1, lineType=linetype)
    cv2.circle(frame, ankle_coord[:2], 7, COLORS["yellow"], -1, lineType=linetype)
    cv2.circle(frame, foot_coord[:2], 7, COLORS["yellow"], -1, lineType=linetype)
